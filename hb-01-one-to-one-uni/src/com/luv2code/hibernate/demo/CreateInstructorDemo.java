...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) {
		...
		try {
			//Crea los objetos
			Instructor tempInstructor = new Instructor("Oscar", "Gomez", "ogomez@una");
			InstructorDetail tempInstructorDetail = new InstructorDetail("ogomez/youtube", "Play the guitar");
